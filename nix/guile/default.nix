{
  ...
  isUnusedTargetInput = package:
    builtins.elem (package.pname or (lib.getName package)) [
      "libtool"
      "readline"
    ];

  isWrapperHook = package: (package.pname or (lib.getName package)) == "make-shell-wrapper-hook";
  ...
  base.overrideAttrs (old: {
    ...
    postInstall = ''
      ...
      sed -i "$out/lib/pkgconfig/guile"-*.pc \
        ...
        -e "s|^Cflags:\(.*\)$|Cflags: -D_WASI_EMULATED_SIGNAL -I${gmp.dev}/include -I${libunistring.dev}/include \1|g" \
